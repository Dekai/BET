...
import com.dk.alirr.util.RrConstants;
...
@ControllerAdvice
public class  DkExceptionHandler implements ProblemHandling, SecurityAdviceTrait {
    ...
    @Value("${dk.application.name}")
    private String applicationName;

    private final Environment env;

    public DkExceptionHandler(Environment env) {
        this.env = env;
    }
    ...
    public ProblemBuilder prepare(final Throwable throwable, final StatusType status, final URI type) {
        ...
        if (activeProfiles.contains(RrConstants.SPRING_PROFILE_PRODUCTION)) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.dk.alirr");
    }
}